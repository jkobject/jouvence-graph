...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/cell_line_from_organism.parquet`
- Logical rows: **1,183**
- Physical objects: **1**
- Bytes: **12,929**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/cell_line_from_organism.parquet` | 1,183 | 12,929 | `1785155480945673` | `kwlqxA==` | `N3k9qtzOkKInLj/zLyPINA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/cell_line_from_organism.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/cell_line_from_organism.parquet'))
