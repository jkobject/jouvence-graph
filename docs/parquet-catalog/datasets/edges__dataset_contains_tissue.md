...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/dataset_contains_tissue.parquet`
- Logical rows: **27**
- Physical objects: **1**
- Bytes: **5,447**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/dataset_contains_tissue.parquet` | 27 | 5,447 | `1785155481793607` | `+VGYUg==` | `s/1YO7aeuiep4Du47hpHhg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/dataset_contains_tissue.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/dataset_contains_tissue.parquet'))
