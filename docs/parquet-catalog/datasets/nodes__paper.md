...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/nodes/paper.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/nodes/paper.parquet` | 2,958,199 | 26,231,759 | `1785155479308410` | `7S3Tng==` | `/r9faeF1qZca9h0DB3K8sA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/nodes/paper.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/nodes/paper.parquet'))
