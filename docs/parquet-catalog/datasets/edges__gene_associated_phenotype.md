...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/gene_associated_phenotype.parquet`
- Logical rows: **3,330**
- Physical objects: **1**
- Bytes: **19,819**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/gene_associated_phenotype.parquet` | 3,330 | 19,819 | `1785155483521432` | `gB/U8w==` | `vaRjl1yRJAvKUonzqJlFvQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/gene_associated_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/gene_associated_phenotype.parquet'))
