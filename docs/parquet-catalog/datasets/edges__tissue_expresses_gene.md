...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/tissue_expresses_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/tissue_expresses_gene.parquet` | 5,338,736 | 41,362,747 | `1785155489893065` | `H22BCQ==` | `Z20jxG/HwBkMNYi/GDdZzw==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/tissue_expresses_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/tissue_expresses_gene.parquet'))
