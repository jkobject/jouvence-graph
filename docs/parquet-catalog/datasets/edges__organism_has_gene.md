...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/organism_has_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/organism_has_gene.parquet` | 109,325 | 653,414 | `1785155488582377` | `gv9lcw==` | `Vlsl4+PNukG20/M/pgFYrQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/organism_has_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/organism_has_gene.parquet'))
