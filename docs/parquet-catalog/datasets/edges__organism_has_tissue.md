...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/organism_has_tissue.parquet`
- Logical rows: **16,061**
- Physical objects: **1**
- Bytes: **111,760**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/organism_has_tissue.parquet` | 16,061 | 111,760 | `1785155488738139` | `5UkWYQ==` | `Hc4ghCjAQWGN/AtR2ZWp8g==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/organism_has_tissue.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/organism_has_tissue.parquet'))
