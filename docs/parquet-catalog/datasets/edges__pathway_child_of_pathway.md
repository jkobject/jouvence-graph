...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/pathway_child_of_pathway.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/pathway_child_of_pathway.parquet` | 147,680 | 941,024 | `1785155488901473` | `Bxu68w==` | `wo2zgKvosDY7Z7xpf3b7oA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/pathway_child_of_pathway.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/pathway_child_of_pathway.parquet'))
