...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/molecule_synergizes_molecule.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/molecule_synergizes_molecule.parquet` | 2,672,628 | 4,284,625 | `1785155484817964` | `iQeHYQ==` | `eea/DOo7o4LqxYp0JVweFw==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/molecule_synergizes_molecule.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/molecule_synergizes_molecule.parquet'))
