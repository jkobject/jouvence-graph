...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/cell_line_expresses_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/cell_line_expresses_gene.parquet` | 20,928,056 | 271,722,507 | `1785155480686152` | `zhyHFQ==` | `B02tdDpX0gZopzqeu2sjJA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/cell_line_expresses_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/cell_line_expresses_gene.parquet'))
