...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/cell_type_expresses_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/cell_type_expresses_gene.parquet` | 1,561,873 | 6,532,333 | `1785155481432694` | `7dWZWg==` | `39oktc2xzF//JLMYYhisvA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/cell_type_expresses_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/cell_type_expresses_gene.parquet'))
