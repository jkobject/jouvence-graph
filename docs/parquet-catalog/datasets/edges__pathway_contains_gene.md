...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/pathway_contains_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/pathway_contains_gene.parquet` | 630,932 | 5,891,672 | `1785155489096958` | `Ufj+8Q==` | `0u5RhQGC7+c3lsllp4AM3g==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/pathway_contains_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/pathway_contains_gene.parquet'))
