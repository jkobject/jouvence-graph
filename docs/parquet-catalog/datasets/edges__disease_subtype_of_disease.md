...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/disease_subtype_of_disease.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/disease_subtype_of_disease.parquet` | 104,809 | 648,897 | `1785155483031395` | `Q63HnA==` | `90RFFncsJZ9Wj5EiMzcwRg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/disease_subtype_of_disease.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/disease_subtype_of_disease.parquet'))
