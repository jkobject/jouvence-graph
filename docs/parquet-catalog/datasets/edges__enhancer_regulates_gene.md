...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/enhancer_regulates_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/enhancer_regulates_gene.parquet` | 48,808,144 | 1,997,157,871 | `1785155483362416` | `MNF0ow==` | `wZPnYXmcbGyQfcAdGioZgw==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/enhancer_regulates_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/enhancer_regulates_gene.parquet'))
