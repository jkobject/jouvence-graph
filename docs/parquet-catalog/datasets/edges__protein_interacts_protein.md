...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/protein_interacts_protein.parquet`
- Logical rows: **3,550**
- Physical objects: **1**
- Bytes: **30,420**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/protein_interacts_protein.parquet` | 3,550 | 30,420 | `1785155489721915` | `GU+mCQ==` | `E1Cw2OWAHaYHAuy8kxxwog==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/protein_interacts_protein.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/protein_interacts_protein.parquet'))
