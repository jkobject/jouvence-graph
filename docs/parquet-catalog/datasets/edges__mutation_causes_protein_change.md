...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/mutation_causes_protein_change.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/mutation_causes_protein_change.parquet` | 177,735 | 2,640,740 | `1785155488079071` | `9nwQNQ==` | `5TRtuQuYxgHv8QrjqzURew==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/mutation_causes_protein_change.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/mutation_causes_protein_change.parquet'))
