...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/molecule_treats_disease.parquet`
- Logical rows: **14,135**
- Physical objects: **1**
- Bytes: **57,319**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/molecule_treats_disease.parquet` | 14,135 | 57,319 | `1785155486922602` | `5SqHVw==` | `eaFp6AYU6VBmXjxFxfAK5Q==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/molecule_treats_disease.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/molecule_treats_disease.parquet'))
