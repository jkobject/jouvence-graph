...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/molecule_parent_of_molecule.parquet`
- Logical rows: **4,140**
- Physical objects: **1**
- Bytes: **19,797**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/molecule_parent_of_molecule.parquet` | 4,140 | 19,797 | `1785155484679611` | `lBYRsQ==` | `OEqS3FWlGG5lPX3u0wNUow==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/molecule_parent_of_molecule.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/molecule_parent_of_molecule.parquet'))
