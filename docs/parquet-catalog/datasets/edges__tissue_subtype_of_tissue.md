...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/tissue_subtype_of_tissue.parquet`
- Logical rows: **28,064**
- Physical objects: **1**
- Bytes: **238,663**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/tissue_subtype_of_tissue.parquet` | 28,064 | 238,663 | `1785155490181678` | `dRFrSg==` | `fVg5r79b1wPCrEANXf536w==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/tissue_subtype_of_tissue.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/tissue_subtype_of_tissue.parquet'))
