...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/molecule_contraindicates_disease.parquet`
- Logical rows: **30,675**
- Physical objects: **1**
- Bytes: **67,065**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/molecule_contraindicates_disease.parquet` | 30,675 | 67,065 | `1785155484349742` | `4nlliA==` | `ixr4zyqm6tV++hhcKn9lCA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/molecule_contraindicates_disease.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/molecule_contraindicates_disease.parquet'))
