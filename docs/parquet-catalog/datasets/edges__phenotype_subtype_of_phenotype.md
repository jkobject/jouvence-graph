...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/phenotype_subtype_of_phenotype.parquet`
- Logical rows: **37,472**
- Physical objects: **1**
- Bytes: **266,843**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/phenotype_subtype_of_phenotype.parquet` | 37,472 | 266,843 | `1785155489255840` | `4PL6iA==` | `V5PLVbt3kn+RkoW2BHUmNg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/phenotype_subtype_of_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/phenotype_subtype_of_phenotype.parquet'))
