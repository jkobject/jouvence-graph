...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/disease_involves_pathway.parquet`
- Logical rows: **2,296**
- Physical objects: **1**
- Bytes: **69,329**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/disease_involves_pathway.parquet` | 2,296 | 69,329 | `1785155482593137` | `u1qK6A==` | `hJGj23LA425r+jDG+BUZxg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/disease_involves_pathway.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/disease_involves_pathway.parquet'))
