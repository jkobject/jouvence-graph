...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/nodes/dataset.parquet`
- Logical rows: **1**
- Physical objects: **1**
- Bytes: **2,579**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/nodes/dataset.parquet` | 1 | 2,579 | `1785155477598313` | `j4ZN5w==` | `wb+nMOuydmpoHpGu9LL93w==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/nodes/dataset.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/nodes/dataset.parquet'))
