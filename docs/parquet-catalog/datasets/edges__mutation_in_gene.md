...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/mutation_in_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/mutation_in_gene.parquet` | 2,599,525 | 19,913,850 | `1785155488238195` | `fs0JZg==` | `rdOXaLA95h9W3Kg6yN+qYg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/mutation_in_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/mutation_in_gene.parquet'))
