...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/disease_associated_gene.parquet`
- Logical rows: **83,339**
- Physical objects: **1**
- Bytes: **314,067**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/disease_associated_gene.parquet` | 83,339 | 314,067 | `1785155482007624` | `BeQhmg==` | `7FWBVKWpVNDyRY0Z5knChA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/disease_associated_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/disease_associated_gene.parquet'))
