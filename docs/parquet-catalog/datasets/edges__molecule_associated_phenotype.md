...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/molecule_associated_phenotype.parquet`
- Logical rows: **64,784**
- Physical objects: **1**
- Bytes: **111,612**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/molecule_associated_phenotype.parquet` | 64,784 | 111,612 | `1785155484199958` | `pMESXg==` | `jDlMgFXi8mabZULz/sOQnQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/molecule_associated_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/molecule_associated_phenotype.parquet'))
