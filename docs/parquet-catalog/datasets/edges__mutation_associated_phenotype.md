...
- As of: `2026-07-27`
- Canonical URI/pattern: `gs://jouvencekb/main/edges/mutation_associated_phenotype.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/main/edges/mutation_associated_phenotype.parquet` | 164,406 | 1,262,716 | `1785155487890849` | `BZw6Sw==` | `2bdBcneMYEvOIdNdQ6clWQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/main/edges/mutation_associated_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/main/edges/mutation_associated_phenotype.parquet'))
